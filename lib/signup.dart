...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget form() {
    return Container(
      padding: EdgeInsets.only(left: _width / 6.0, right: _width / 6.0),
      child: Form(
        key: _key,
        child: Column(
          children: <Widget>[
  ...
  void Signup() async {
    if (_key.currentState.validate()) {
      FirebaseAuth.instance
        ...
        await uploadPic();
        UserManagement().storeNewUser(Name, Email, Password, phoneNumber,
            ImageUrl, RollNumber, Course, Semester, signedInUser.user, context);
      }).catchError((e) {
